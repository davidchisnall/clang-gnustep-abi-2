...
// __stop symbols work.
// CHECK-NEW: @.objc_null_selector = linkonce_odr hidden global %1 zeroinitializer, section "__objc_selectors", comdat, align 8
// CHECK-NEW: @.objc_null_category = linkonce_odr hidden global %2 zeroinitializer, section "__objc_cats", comdat, align 8
// CHECK-NEW: @.objc_null_protocol = linkonce_odr hidden global %3 zeroinitializer, section "__objc_protocols", comdat, align 8
// CHECK-NEW: @.objc_null_protocol_ref = linkonce_odr hidden global %4 zeroinitializer, section "__objc_protocol_refs", comdat, align 8
...
// CHECK-NEW-NEXT: call void @__objc_load(%0* @.objc_init)
